...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Welcome to Pariprashna!');
      navigate('/');
    } catch (error) {
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Create your account to start asking</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <p className="text-center mt-6 text-[14px] text-gray-500">
            ...
            <Link to="/login" className="text-brand font-medium hover:text-brand-500">
              Sign in
            </Link>
          </p>
        </div>
